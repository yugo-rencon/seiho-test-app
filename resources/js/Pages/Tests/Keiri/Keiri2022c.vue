        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                    ...
                    :contents="[
                        // 問21
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['40歳：4,500千円 × 116 × 0.995037 = 519,409千円', '41歳：4,500千円 × 126 × 0.985185 = 558,600千円', '42歳：4,500千円 × 137 × 0.975431 = 601,353千円', '43歳：4,500千円 × 147 × 0.965773 = 638,859千円', '44歳：4,500千円 × 159 × 0.956211 = 684,169千円'],
                                },
                                {
                                    type: 'text',
                                    value: '② 合計',
                        ...
                        // 問24
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['40歳：P × 98,052 × 1.000000 = 98,052P', '41歳：P × 97,936 × 0.990099 = 96,966P', '42歳：P × 97,810 × 0.980296 = 95,883P', '43歳：P × 97,673 × 0.970590 = 94,800P', '44歳：P × 97,525 × 0.960980 = 93,720P'],
                                },
                                {
                                    type: 'formulaBlock',
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-25 確認済み
                        '予定死亡率を低く、予定利率を高くすると、定期保険と養老保険の純保険料は[[低くなる]]。', //p53
                        '正しい',
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //39
                        {
                            ...
                            content: '団体年金の場合、大数の法則に加えて[[企業等の財政負担力に依存している]]。、', //p156
                        }, //40
                        {
                            // rev: 2026-07-11 確認済み
