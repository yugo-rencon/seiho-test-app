            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '正しい',
                        '契約時の査定・決定は死亡保険の査定基準を入院・手術保障のある保険に準用している部分もあるが、[[徐々に入院・手術保障独自の査定標準（基準）が完備されつつある]]。', //p151
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //35
                        {
                            ...
                            content: '危険選択においては、年齢・性別・職業・体格・家族歴・現病歴・既往歴・[[生活習慣]]・[[嗜好]]等が死亡率に影響を与えると考えられ、査定標準ではこれらの各因子をどの様に危険選択上評価すべきかが示されている。', //p111
                        }, //36
                        {
                            // rev: 2026-07-04 確認済み
                            questionTitle: '保険金確認',
