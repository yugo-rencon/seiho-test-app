            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '認可を受けない保険約款もその内容が強行規定や公益に反するものでない限り、保険契約者との間では[[有効]]であるとするのが判例、通説である。', //p11
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-08-23 確認済み
                        '保険契約者は自己の名において契約し、保険者に対して自ら保険料支払義務を負うのであって、[[保険金受取人の代理人として契約するのではない]]。', //p55
                        '正しい',
                        '民法上の「第三者のためにする契約」における第三者の権利取得のためには、その第三者の受益の意思表示が必要とされているのに対し、「第三者のためにする生命保険契約等」における保険金受取人は、[[特別な受益の意思表示を要せず]]して当然に契約上の権利を取得する。', //p56
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="23"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-08-20 確認済み
                        '正しい',
                        '相互会社同士の合併の場合は、合併後の会社も[[相互会社]]であることを要する。', //p252
                        '保険法 → 会社法', //p252
                    ]"
                />
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-08-20 確認済み
                        '将来における配当に関して断定的判断を示すこと等についても[[禁止の対象となる]]。', //p269
                        '基礎書類に基づく行為である場合は[[禁止されていない]]。', //p268
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :subject="subject"
                    questionTitle="乗合の禁止"
                    :relatedProblems="['2024a40', '2024c30']"
                    :contents="[
                        // rev: 2026-08-18 確認済み
                    ...
                    :items="[
                        {
                            ...
                            questionTitle: '生命保険契約等に対する法の適用',
                            relatedProblems: ['2024a21', '2024b21', '2024c21', '2024c31'],
                            content: '営利保険の保険者は株式会社であることから、営利保険の引受については、いわゆる営業的商行為として、商法の商行為一般に関する規定の適用を受けるが、相互会社が行う保険は相互保険であるとしても、保険業法により、商法が準用され、商行為一般の規定の準用を受ける。', //p5-6
                        }, //31
                        {
                            // rev: 2026-08-13 確認済み
                        ...
                        }, //34
                        {
                            ...
                            content: '保険契約者以外の者の死亡によって保険金の支払を行う旨を定める死亡保険契約において、保険契約成立後、保険契約者が保険金受取人を変更するにはその保険契約者以外の者である[[被保険者の同意を要する]]。', //p57
                        }, //35
                        {
                            // rev: 2026-08-13 確認済み
                        ...
                        }, //37
                        {
                            ...
                            content: '保険約款では、「貸付金の元利金が解約返戻金額をこえた（いわゆるオーバーローンになった）場合に[[生命保険会社から通知した金額を所定の期日までに保険契約者が払い込まなかったときは、保険契約は失効する]]」旨規定するのが一般的である。', //p157
                        }, //38
                        {
                            // rev: 2026-08-13 確認済み
                            questionTitle: '監督の方法',
                            relatedProblems: ['2024c39'],
                            content: '正しい',
                        }, //39
                        {
                            // rev: 2026-08-21 確認済み
                            ...
                            content: '法人であることが条件 → 法人でなくてもよく、個人でもよい', //p257
                        }, //40
                        {
                            // rev: 2026-08-16 確認済み
                            questionTitle: '生命保険契約等の性質',
                            relatedProblems: ['2024a22', '2024c41'],
                            label: 'ア',
                            content: '射倖',
                        }, //41
                        {
                        ...
                        }, //47
                        {
                            // rev: 2026-08-16 確認済み
                            questionTitle: '基礎書類',
                            relatedProblems: ['2024a29', '2024c48'],
                            label: 'エ',
                            content: '定款',
                        }, //48
                        {
