        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-09-02 確認済み
                        '総勘定元帳から仕訳帳 → 仕訳帳から総勘定元帳', //p15
                        '2つに区分 → 3つに区分（合計試算表、残高試算表、合計残高試算表）', //p15-16
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-09-01 確認済み
                        '例えば、資産は企業それ自体の財産であり、[[所有者の財産と分離することができる]]。', //p6
                        '正しい',
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //32
                        {
                            ...
                            content: '流通市場における開示書類には、[[「有価証券報告書」「半期報告書」「臨時報告書」]]等がある（有価証券届出書、目論見書は発行市場における開示書類）。', //p30
                        }, //33
                        {
                            // rev: 2026-09-02 確認済み
            ...
            <TestNavigationButtons previous-route="kaikei2024b" next-route="kaikei2023a" />
        </section>
    </SeihoTestLayout>
</template>
