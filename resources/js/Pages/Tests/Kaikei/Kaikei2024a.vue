                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        { questionTitle: '貸借対照表', content: '正しい' }, //32
                        {
                            ...
                            content:
                                '「明瞭性の原則」ではなく、「資本取引・損益取引区分の原則」。「明瞭性の原則」では「企業会計は、財務諸表によって、利害関係者に対し必要な会計事実を明瞭に表示し、企業の状況に関する判断を誤らせないようにしなければならない。」と定めている。',
                        }, //33
                        { questionTitle: '決算の目的', content: '期中の保険料収入や保険金支払が<u><b>現金主義</b></u>で認識されている生命保険会社にあっては、その損益基準を<u><b>発生主義</b></u>に修正するうえで極めて重要な意味を持つ。' }, //34
                        ...
                        { questionTitle: '負債勘定', content: '正しい' }, //37
                        {
                            ...
                            content:
                                '生命保険会社が支払う税金のうち、法人税やそれを基礎として計算される都道府県民税・市町村民税については、原則として当期に生じた剰余金から支払われるべきものであるから、損益計算書上、<u><b>他の税金と区別して</b></u>税引前当期剰余から控除する形式で表示される。',
                        }, //38
                        { questionTitle: '区分経理における運用資産の管理', content: '正しい' }, //39
                        { questionTitle: '会計監査人による監査', content: '期中監査は日常業務の取引記録が正確に会計数値として反映されているかといった日々の記帳内容に主眼が置かれるのに対して、決算監査は財務諸表の適法性や決算整理事項の内容監査が中心となる。' }, //40
                        // 問41〜50
