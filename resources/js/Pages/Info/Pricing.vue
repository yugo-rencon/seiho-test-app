...
const scopePlan = computed(() => {
    if (currentScope.value === "ippan") {
        return {
            ...
            freeDescription: "生命保険一般課程の2025年試験を無料公開しています。",
            freeFeatures: ["生命保険一般課程 2025年 全フォーム"],
        };
    }
    ...
    if (currentScope.value === "senmon") {
        return {
            ...
            freeDescription: "生命保険専門課程の2025年試験を無料公開しています。",
            freeFeatures: ["生命保険専門課程 2025年 全フォーム"],
        };
    }
    ...
    if (currentScope.value === "ouyou") {
        return {
            ...
            freeDescription: "生命保険応用課程の2025年試験を無料公開しています。",
            freeFeatures: ["生命保険応用課程 2025年 全フォーム"],
        };
    }
