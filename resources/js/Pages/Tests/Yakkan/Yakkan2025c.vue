...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                                :items="[
                    // 問31〜40
                    { label: '解', content: '営利保険の保険者は株式会社であることから、営利保険の引受については、いわゆる営業的商行為として、商法の商行為一般に関する規定の適用を受ける。一方で、相互会社が行う保険は相互保険であるとしても、保険業法により商法が準用され、商行為一般の規定の準用を受ける。' }, //31
                    ...
                    { label: '解', content: '保険契約成立後、保険契約者が保険金受取人を変更するにはその保険契約者以外の者である被保険者の同意が必要である。。' }, //35
                    ...
                    { label: '解', content: '保険約款では、貸付金の元利金が解約返戻金額をこえた（いわゆるオーバーローンになった）場合に、<u><b>生命保険会社から通知した金額を所定の期日までに保険契約者が払い込まなかったとき</b></u>は、保険契約は失効する旨規定するのが一般的である。' }, //38
                    { label: '解', content: '正しい' }, //39
                    { label: '解', content: '「外国保険業者」とは、外国の法令に準拠して外国において保険業を行う者をいう。なお、<u><b>外国保険業者の場合は、株式会社や相互会社でなくてもよく、個人でもよい</b></u>。' }, //40
                    // 問41〜50
        ...
        <TestNavigationButtons
            previous-route="yakkan2025b"
            next-route="yakkan2024a"
        />
