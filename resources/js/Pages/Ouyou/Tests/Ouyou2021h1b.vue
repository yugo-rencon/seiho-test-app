...
const subject = "2021年度 4月〜7月実施 フォームB";
const isDraft = false;
</script>
...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '収入金額から退職所得控除額を差し引いた額の全額 → 収入金額から退職所得控除額を差し引いた残りの1/2', //p17
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '6ヶ月以内 → 10ヶ月以内', //p52
                        '正しい',
                        '相続財産で物納することはできない → 延納によっても現金で納付することが困難な場合、相続財産で物納することができる', //p53
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="4"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '生活設計販売 → 制度設計販売<br>生活保障制度を販売 → 福利厚生制度を販売', //p73
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="18"
            ...
            <TestNavigationButtons previous-href="/ouyou/2021-h1-a" next-href="/ouyou/2021-h2-a" home-route="ouyou.index" />
        </section>
    </SeihoTestLayout>
</template>
