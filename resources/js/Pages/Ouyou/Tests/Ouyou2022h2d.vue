...
const subject = "2022年度 8月〜3月実施 フォームD";
const isDraft = false;
</script>
        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="[]"
                    :contents="[
                        '借りたい人が多ければ[[金利は上昇]]し、貸したい人が多ければ[[金利は低下]]する', //p127
                        '正しい',
                        '正しい',
                        '正しい',
                    ]"
            ...
            <TestNavigationButtons previous-href="/ouyou/2022-h2-c" next-href="/ouyou/2021-h1-a" home-route="ouyou.index" />
        </section>
    </SeihoTestLayout>
</template>
