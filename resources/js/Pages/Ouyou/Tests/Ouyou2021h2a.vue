...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        '厚生労働大臣 → 内閣総理大臣', //p148
                        '媒介 → 代理', //p149
                        '[[保険募集を行う際]]には、お客さまに[[「契約概要」および「注意喚起情報」]]を交付し、記載事項を了知した旨の確認をいただく必要がある', //p149
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="[]"
                    :contents="[
                        '「告知妨害・不告知教唆」として保険業法上の[[禁止行為に該当する]]', //p160
                        '正しい',
                        '正しい',
                        '正しい',
                    ]"
            ...
            <TestNavigationButtons previous-href="/ouyou/2021-h1-b" next-href="/ouyou/2021-h2-b" home-route="ouyou.index" />
        </section>
    </SeihoTestLayout>
</template>
