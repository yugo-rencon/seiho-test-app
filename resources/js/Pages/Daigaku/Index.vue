...
const FP_VISIBLE_YEARS = [2026, 2025, 2024, 2023, 2022, 2021];
...
const isFreeTrialYear = (section, year) =>
    Number(year) === (["shikumi-kojin", "fp"].includes(section?.id) ? 2026 : 2025) && section?.published;
