                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //39
                        {
                            ...
                            content: '少額短期保険業は、短期（生保・医療保険で1年以内、損害保険で2年以内）かつ少額保険金額（疾病による死亡保険金[[300万円]]以内、疾病・傷害による入院給付金等80万円以内、損害保険金[[1,000万円]]以内等で、かつ総額1,000万円以下（複数契約合算））の保険のみを引き受ける保険業である。', //p177
                        }, //40
                        {
                            // rev: 2026-07-06 確認済み
                            questionTitle: '危険の種類',
