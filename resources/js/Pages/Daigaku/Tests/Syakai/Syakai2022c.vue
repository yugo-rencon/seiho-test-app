        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="国民年金の給付に要する費用および国民年金保険料"
                    :relatedProblems="[]"
                    :contents="[
                        '', //p
                        '', //p
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        {
                            // rev: 2026-08-23 確認済み
                            questionTitle: '高額医療・高額介護合算療養費制度',
                            relatedProblems: [],
                            content: '正しい',
                        }, //42
                        {
            ...
            <TestNavigationButtons previous-route="daigaku.syakai2022b" next-route="daigaku.syakai2021a" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
