...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '収入金額から退職所得控除額を差し引いた残りの全額 → 収入金額から退職所得控除額を差し引いた残りの1/2', //p17
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '加給年金などが加算されることはない → 一定の条件を満たすと加給年金などが加算される', //p139
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="10"
            ...
            <TestNavigationButtons previous-href="/ouyou/2023-h2-a" next-href="/ouyou/2023-h2-c" home-route="ouyou.index" />
        </section>
    </SeihoTestLayout>
</template>
