...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                    ...
                    { label: '解', content: '生保の海外投融資は、生保本体で直接行う場合のほか、生保本体と独立した海外現地法人を通じて行う場合がある。' }, //34
                    { label: '解', content: '区分経理ではなく一般勘定と明確に区分された特別勘定が設けられることになった。' }, //35
                    { label: '解', content: '正しい' }, //36
                    { label: '解', content: '正しい' }, //37
                    { label: '解', content: '①キャビタル・ゲインのインカム化、②簿価分離といったメリットがある ' }, //38
                    { label: '解', content: '2008年(平成20年)のサブプライムローン問題に端を発した米国住宅バブル崩壊をきっかけに多分野の資産価格が大幅に下落したことに伴い2000 年(平成12 年)以降増加傾向であった海外投融資は、減少に転じている。' }, //39
