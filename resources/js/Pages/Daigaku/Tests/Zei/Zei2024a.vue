        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="所得の種類・損益通算"
                    :relatedProblems="['2024a1', '2024b13']"
                    :contents="[
                        // rev: 2026-06-09 確認済み
                        '金銭で受領せずに商品等の現物を支給される、いわゆる現物給与も給与所得として[[課税対象となる]]。', //p10
                        '事業として行うものは[[事業所得となる]]。', //p14
                        '正しい',
                        '損失が損益通算できる所得は、不動産所得、事業所得、山林所得、譲渡所得であり、[[特定の各種所得の損失や特別な損失については、損益通算はできない]]こととされている。', //p22
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="2"
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '1年 → 6ヶ月', //p29
                        '初年度は、給与所得者であっても[[年末調整では控除できない]]。', //p31
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="3"
                    ...
                    :contents="[
                        ...
                        '簡易帳簿の方法を採用する青色申告者は、[[貸借対照表の添付は必要ない]]。', //p40
                        '2分の1までの金額 → 全額', //p41
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-06-25 確認済み
                        '解約返戻金のうち父親が負担した保険料に対応する部分について[[贈与があったとみなされて、贈与税が課税される]]。', //p178
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-06-13 確認済み
                        '事業税は経費にすることができる税金であり、法人税の計算においては[[損金の額に算入される]]。', //p219
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '法定相続人の数は、[[相続の放棄があっても、その放棄はなかったものとして計算する]]。', //p126
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '保証期間付終身年金の場合、一括払いで受け取る金額は雑所得として所得税・住民税が課税されるが、[[確定年金]]の場合、一括払いの金額には、[[一時所得]]として所得税・住民税が課税される。', //p174
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="21"
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //44
                        {
                            ...
                            content: '物納にあてることができる財産の種類と順位は、第1順位-国債、地方債、上場株式等、[[不動産、船舶]]、第2順位-非上場株式等、第3順位-[[動産]]となっている。', //p136
                        }, //45
                        {
                            // rev: 2026-06-15 確認済み
            ...
            <TestNavigationButtons previous-route="daigaku.zei2025c" next-route="daigaku.zei2024b" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
