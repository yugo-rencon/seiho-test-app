...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '生命保険契約等においては、損害保険契約と[[異なり]]、被保険利益の存否やその価額としての保険価額等が[[問題とならない]]。したがって、超過保険、一部保険、重複保険等の問題を生ずることはない。', //p40
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="22"
                    :title="title"
                    :subject="subject"
                    questionTitle="自動振替貸付（保険料の立替）"
                    :relatedProblems="['2020c22']"
                    :contents="[
                        // rev: 2026-08-23 確認済み
                        '保険契約者からあらかじめ貸付を受けない旨の申出があった場合には、自動振替貸付は行わない。', //p101
                        '保険契約者は貸付金の元利金をいつでも返済することができるが、保険約款では、保険契約の消滅時には生命保険会社が支払う保険金などの支払金からその元利金を差し引くことによって返済させる旨を[[規定する]]のが一般的である。', //p101
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-08-20 確認済み
                        '正しい',
                        '[[保険法には規定がない]]ものの、一部の生命保険会社において保険約款に規定されている。', //p135
                        'すでに払い込まれた保険料を保険契約者に[[返還する]]」旨の規定をおいている。', //p135
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="24"
                    ...
                    :contents="[
                        // rev: 2026-08-20 確認済み
                        '1996年（平成8年）の保険業法改正により、生命保険業免許と損害保険業免許とが定義された（少額短期保険業免許は含まれない）。', //p204
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2020b31', '2020c26']"
                    :contents="[
                        // rev: 2026-08-20 確認済み
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-08-21 確認済み
                        '正しい',
                        '解約の効力発生時期は、保険契約者の解約の意思表示が生命保険会社に[[到達した時]]である。', //p137
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :subject="subject"
                    questionTitle="基礎書類"
                    :relatedProblems="['2020b48', '2020c30']"
                    :contents="[
                        // rev: 2026-08-20 確認済み
                        '保険者としての義務の範囲を定める方法および履行の時期は、[[普通保険約款]]に規定されている。', //p220
                        '正しい',
                        '正しい',
                    ]"
                />
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //36
                        {
                            ...
                            content: '筆頭株主 → 少数株主', //p227
                        }, //37
                        {
                            // rev: 2026-08-23 確認済み
                            questionTitle: '事業年度',
                            relatedProblems: ['2020c38'],
                            content: '1月1日から12月31日 → 4月1日から翌年3月31日', //p239
                        }, //38
                        {
                            // rev: 2026-08-14 確認済み
                        ...
                        }, //39
                        {
                            ...
                            content: '本国において解散、保険業の廃止をしたときは、[[その旨を金融庁長官に届け出るだけでよい]]。', //p259
                        }, //40
                        {
                            // rev: 2026-08-16 確認済み
                            questionTitle: '契約者保護',
            ...
            <TestNavigationButtons previous-route="yakkan2020b" />
        </section>
    </SeihoTestLayout>
</template>
