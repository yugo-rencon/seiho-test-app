...
const scopePlan = computed(() => {
    if (currentScope.value === "ippan") {
        return {
            price: "¥480",
            description: "生命保険一般課程の全年度・全フォームの解説を一括で解放できます。",
            features: [
                "生命保険一般課程 全50解説を閲覧可能",
                "広告なし。勉強の邪魔を一切しません",
                "今後の追加コンテンツも閲覧可",
    ...
    if (currentScope.value === "senmon") {
        return {
            price: "¥480",
            description: "生命保険専門課程の全年度・全フォームの解説を一括で解放できます。",
            features: [
                "生命保険専門課程 全30解説を閲覧可能",
                "広告なし。勉強の邪魔を一切しません",
                "今後の追加コンテンツも閲覧可",
    ...
    if (currentScope.value === "ouyou") {
        return {
            price: "¥480",
            description: "生命保険応用課程の全年度・全フォームの解説を一括で解放できます。",
            features: [
                "生命保険応用課程 全30解説を閲覧可能",
                "広告なし。勉強の邪魔を一切しません",
                "今後の追加コンテンツも閲覧可",
...
const plans = computed(() => [
    ...
    isBasicExamScope.value
        ? {
              ...
              price: "¥980",
              note: "セット販売",
              description: "生命保険一般課程・専門課程・応用課程の解説をまとめて解放できます。",
              features: [
                  "一般課程 全50解説を閲覧可能",
                  "専門課程 全30解説を閲覧可能",
                  "応用課程 全30解説を閲覧可能",
