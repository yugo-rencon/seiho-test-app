        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="介護保険のサービスの利用・ケアマネジメント"
                    :relatedProblems="[]"
                    :contents="[
                        '', //p
                        '正しい',
...
<QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="雇用保険や在職老齢年金の併給調整等"
                    :relatedProblems="[]"
                    :contents="[
                        '正しい',
                        '正しい',
...
<QuestionTemp1
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        {
                            questionTitle: '障害厚生年金',
                            relatedProblems: [],
                            content: '', //p
                        }, //41
                        {
                            // rev: 2026-08-23 確認済み
                            questionTitle: '国民年金の繰上げ受給',
                            relatedProblems: [],
                            content: '正しい',
                        }, //42
                        {
                            questionTitle: '遺族厚生年金の受給',
                            relatedProblems: [],
                            content: '', //p
                        }, //43
                        {
                            // rev: 2026-08-23 確認済み
                            questionTitle: '公的年金等の源泉徴収',
                            relatedProblems: [],
                            content: '正しい',
                        }, //44
                        {
                            questionTitle: '労災保険の傷病補償年金（傷病年金）',
                            relatedProblems: [],
                            content: '', //p
                        }, //45
                        {
                            questionTitle: '労災給付と公的年金との調整',
                            relatedProblems: [],
                            content: '', //p
                        }, //46
                        {
                            // rev: 2026-08-23 確認済み
                            questionTitle: '健康保険組合の特例退職被保険者',
                            relatedProblems: [],
                            content: '正しい',
                        }, //47
                        {
            ...
            <TestNavigationButtons previous-route="daigaku.syakai2023c" next-route="daigaku.syakai2022b" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
