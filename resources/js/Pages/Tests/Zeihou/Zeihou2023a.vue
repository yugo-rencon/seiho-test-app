...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                    ...
                    { label: '解', content: '所得税法の規定による課税標準は、総所得金額、退職所得所得金額の3つである。' }, //32
                    { label: '解', content: '正しい' }, //33
                    { label: '解', content: '正しい' }, //34
                    { label: '解', content: '正しい' }, //35
                    { label: '解', content: '定められた一定額は益金の額に算入しない。' }, //36
                    { label: '解', content: '正しい' }, //37
                    { label: '解', content: '保険料または掛金の払込みは、年金支払開始日前10年以上の期間にわたって定期に行うものであること（一時払契約は不可）' }, //38
