            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                    ...
                    :contents="[
                        // 問21
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金現価の合計', '= 256,720 + 279,300 + 304,334 + 330,294 + 358,579', '= 1,529,227千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 1,529,227千円',
                                },
                            ],
                        },
                        // 問22
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：150万円 = 1,500千円', '5年後（50歳）の生存数：96,319人', '5年の期末払現価率：0.951466'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['満期保険金の現価', '= 96,319 × 1,500 × 0.951466', '= 137,466,380.481千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 137,466,380千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問23
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：150万円 = 1,500千円', '予定事業費：保険金1000円につき25円 = 25 ÷ 1000', '45歳の生存数：97,366人'],
                                },
                                {
                                    type: 'text',
                                    value: '① 1人あたりの予定事業費',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['= 37.5千円 × 97,366人', '= 3,651,225千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 3,651,225千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問24
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価の合計', '= 97,366P + 96,232P + 95,094P + 93,951P + 92,801P', '= 475,444P'],
                                },
                                {
                                    type: 'text',
                                    value: '② 支出現価（問21〜23より）',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金の現価（問21）= 1,529,227千円', '満期保険金の現価（問22）= 137,466,380千円', '予定事業費の現価（問23）= 3,651,225千円'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['支出現価', '= 1,529,227 + 137,466,380 + 3,651,225', '= 142,646,832千円 = 142,646,832,000円'],
                                },
                                {
                                    type: 'text',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価 = 支出現価 より', '475,444P = 142,646,832,000円', 'P = 142,646,832,000円 ÷ 475,444', 'P = 300,028…円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 300,030円（10円未満四捨五入）',
                                },
                            ],
                        },
                    ]"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-12 確認済み
                        '正しい',
                        '契約者に魅力を感じさせるに十分な料率でなければならないが、これは[[他社や隣接業界より営業保険料を安くすることを必ずしも意味していない]]。', //p57
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :relatedProblems="['2022b27', '2022c11']"
                    :contents="[
                        // rev: 2026-07-19 確認済み
                        '正しい',
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //36
                        {
                            ...
                            content: 'チルメル式保険料積立金 → 解約までの経過期間に応じた純保険料式保険料積立金', //p108
                        }, //37
                        {
                            // rev: 2026-07-11 確認済み
                        ...
                        {
                            // rev: 2026-08-08 確認済み
                            relatedProblems: ['2022b40', '2022c49'],
                            questionTitle: '特別勘定の位置付け',
                            content: '保険業法上の規定によるものでなく → 保険業法上の規定によるもの', //p145
                        }, //40
                        {
                            // rev: 2026-07-11 確認済み
