...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                                :items="[
                    // 問31〜40
                    { content: 'エコノミストではなくアナリストの説明。' }, //31
                    { content: '保険金信託業務は、付随業務ではなく法定他業に規定されている。' }, //32
                    { content: '正しい' }, //33
                    { content: '事務リスクではなく信用リスク。また即時の流動化は容易ではなく困難。' }, //34
                    { content: '正しい' }, //35
                    { content: '正しい' }, //36
                    { content: '子会社形態により互いに他業態の業務を行うことが可能である。' }, //37
                    { content: '正しい' }, //38
                    { content: 'フリー・クリア・ワイドではなくフリー・フェアー・グローバル。' }, //39
                    { content: '正しい' }, //40
                    // 問41〜50
                    { label: 'イ', content: '独占禁止法' }, //41
                    { label: 'エ', content: '安全性' }, //42
                    { label: 'ウ', content: '短期' }, //43
                    { label: 'エ', content: '当期純利益' }, //44
                    { label: 'オ', content: '' }, //45
                    { label: 'オ', content: '' }, //46
                    { label: 'ア', content: 'シンジケート' }, //47
                    { label: 'ア', content: '子会社を通じて' }, //48
                    { label: 'イ', content: 'ヘッジファンド' }, //49
                    { label: 'イ', content: 'キャピタル・ゲイン' }, //50
                ]"
