...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                    ...
                    { label: '解', content: '死亡保険契約の保険者は、保険金受取人が被保険者を故意に死亡させたとき保険給付を行う責任を負わない。ただし、被保険者を故意に死亡させた保険金受取人以外の保険金受取人に対する責任については、この限りでない。' }, //33
                    ...
                    { label: '解', content: '6ヶ月以内ではなく、1ヶ月以内。' }, //35
                    ...
                    { label: '解', content: '生命保険会社の名称変更のみを行う場合も金融庁長官の認可は必要である。' }, //38
                    { label: '解', content: '金融庁長官ではなく、内閣総理大臣。' }, //39
