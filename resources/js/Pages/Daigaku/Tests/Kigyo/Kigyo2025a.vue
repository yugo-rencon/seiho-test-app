        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="経営者の死亡リスクに対する必要保障額の考え方"
                    :relatedProblems="[]"
                    :contents="[
                        '正しい',
                        '', //p
            ...
            <TestNavigationButtons next-route="daigaku.kigyo2025b" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
