...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        {
                            // rev: 2026-08-23 確認済み
                            questionTitle: '第三者行為による傷害の給付（健康保険）',
                            relatedProblems: [],
                            content: '正しい',
                        }, //49
                    ]"
            ...
            <TestNavigationButtons previous-route="daigaku.syakai2024b" next-route="daigaku.syakai2023a" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
