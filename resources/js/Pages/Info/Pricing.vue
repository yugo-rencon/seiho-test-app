...
const scopePlan = computed(() => {
    if (currentScope.value === "ippan") {
        return {
            ...
            freeDescription: "生命保険一般課程の2026年1月〜6月実施フォームA〜Eは、無料登録・ログイン後に公開しています。",
            freeFeatures: ["生命保険一般課程 2026年1月〜6月 フォームA〜E"],
        };
    }
    ...
    if (currentScope.value === "senmon") {
        return {
            ...
            freeDescription: "生命保険専門課程の2026年4月〜8月実施フォームAを無料公開しています。",
            freeFeatures: ["生命保険専門課程 2026年4月〜8月 フォームA"],
        };
    }
