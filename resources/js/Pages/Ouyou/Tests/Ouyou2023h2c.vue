...
const subject = "2023年度 8月〜3月実施 フォームC";
const isDraft = false;
</script>
        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        '正しい',
                        '贈与税の課税対象 → 相続税（保険金非課税の取り扱い無し）の課税対象', //p59
                        '雑所得として所得税の課税対象 → 一時所得として所得税の課税対象', //p59
                        '所得税が課税 → 相続税または贈与税が課税', //p59
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="4"
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="法人税、法人の住民税・事業税"
                    :relatedProblems="[]"
                    :contents="[
                        '正しい',
                        '株主等が5人以下およびその同族関係者で発行株式総数または出資金額あるいは議決権等の30%超を有する会社 → 株主等が3人以下およびその同族関係者で発行株式総数または出資金額あるいは議決権等の50%超を有する会社', //p79
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '被保険者期間が6ヶ月以上 → 被保険者期間が1ヶ月以上', //p139
                        '在職老齢年金 → 加給年金', //p139
                    ]"
                />
                <QuestionTemp1
                    ...
                    :contents="[
                        '厚生労働大臣 → 内閣総理大臣', //p148
                        '媒介 → 代理', //p149
                        'お客さまから「契約概要」および「注意喚起情報」を記載した書面の記載事項を了知した旨の[[確認をいただく必要がある]]', //p149
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        '正しい',
                        '総収入金額から、その収入を得るために支出した金額（必要経費）を差し引くことができない → 総収入金額から、その収入を得るために支出した金額（必要経費）を差し引いた金額が事業所得', //p16
                        '正しい',
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :relatedProblems="[]"
                    :contents="[
                        '課税価格の合計額が基礎控除額以下である場合でも相続税の申告が必要 → 相続税の申告は不要', //p52
                        '正しい',
                        '正しい',
                        '正しい',
                    ]"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        '正しい',
                        '正しい',
                        '給与所得として所得税の課税対象 → 退職所得として所得税の課税対象', //p99
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="生命保険と保全・アフターサービス"
                    :relatedProblems="[]"
                    :contents="[
                        '正しい',
                        '正しい',
            ...
            <TestNavigationButtons previous-href="/ouyou/2023-h2-b" next-href="/ouyou/2023-h2-d" home-route="ouyou.index" />
        </section>
    </SeihoTestLayout>
</template>
