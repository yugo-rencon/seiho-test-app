        ...
        <section class="bg-[#fdfbff] text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '若年層には[[先天性]]のものが多く、中年および高年齢になると[[高血圧性]]、[[虚血性]]が多くなる。', //p65
                        'ネフローゼ → インシュリン', //p66
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :subject="subject"
                    questionTitle="契約制限"
                    :relatedProblems="['2025b24', '2025c23']"
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '正しい',
                        '一般に[[短期]]養老または[[短期]]払込養老保険の経験死亡率は[[長期]]のものより良好である。ただし、定期保険ではこの関係は逆転し、保険期間が[[短期]]のものに逆選択が集中する傾向がある。', //p73
                        '役員を被保険者とする場合も[[被保険者の書面による加入同意が必要]]である。', //p75
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="25"
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '生命保険における死亡危険と比較して、入院・手術保障のある保険における危険は、心理的要因と社会的要因によって[[大きく影響される特性がある]]。', //p149
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '約款上では書面による告知をした時以降に生じた事項については、[[告知義務はないとしている]]。', //p16
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="27"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-04 確認済み
                        '正しい',
                        '復活時に求める告知事項の時間的範囲を、過去全体にすべきか、契約後とすべきかについては、理論的には、契約時までのものは告知済みであるから、[[復活時には契約後の健康歴その他の告知を求めるのが普通である]]。', //p173
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :items="[
                        {
                            ...
                            content: '生命表には国民全体を対象とした[[国民生命表]]と、それよりは小さな特定集団（たとえば生命保険の被保険者集団）を対象とする[[経験生命表]]とがある。', //p5
                        }, //31
                        {
                            // rev: 2026-07-05 確認済み
                        ...
                        }, //35
                        {
                            ...
                            content: '被保険者の死亡後に、重要事実についての告知義務違反の事実が判明して契約解除を行うためには、[[既往歴など告知義務違反の事実と死因との間に因果関係がなければならない]]。 ', //p120
                        }, //36
                        {
                            // rev: 2026-07-05 確認済み
                            questionTitle: '機微（センシティブ）情報',
                            relatedProblems: ['2025b37'],
                            content: '本人、国の機関、地方公共団体、新聞などにより公開されている情報及び外形から明白な身体等に関する情報は、[[機微（センシティブ）情報に該当しない]]。', //p132
                        }, //37
                        {
            ...
            <!-- ボタングループ -->
            <TestNavigationButtons previous-route="kiken2025a" next-route="kiken2025c" />
        </section>
    </SeihoTestLayout>
</template>
