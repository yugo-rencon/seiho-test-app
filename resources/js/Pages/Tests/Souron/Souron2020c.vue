            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい', //23-イ
                        '保険金受取人の資格について制限はない（行為能力者である必要もない）', //23-ウ p14
                    ]"
                />
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        { content: '正しい' }, //33
                        { content: '連邦政府 → 州政府' }, //34 p65
                        { content: '正しい' }, //35
                        { content: '相互会社から株式会社 → 株式会社から相互会社' }, //36 p78
                        { content: '国 → 各市町村' }, //37 p141
                        { content: '責任準備金 → 供託金' }, //38 p159
                        { content: '正しい' }, //39
                        { content: '正しい' }, //40
                        // 問41〜50（ア〜オ）
