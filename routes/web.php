...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('english-books/{englishBook}', [EnglishBookAdminController::class, 'show'])->name('admin.englishBooks.show');
    Route::get('english-books/{englishBook}/guide', [EnglishBookAdminController::class, 'guide'])->name('admin.englishBooks.guide');
