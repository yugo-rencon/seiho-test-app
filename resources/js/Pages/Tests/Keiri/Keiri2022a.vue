        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                <QuestionTemp4
                    ...
                    :contents="[
                        ...
                        // 問５
                        {
                            ...
                            answer: '12,610',
                            questionTitle: '純保険料',
                            relatedProblems: ['2022a5', '2022b5', '2022c5'],
                            explanation: [
                                {
                                    type: 'blockTitle',
                                    value: '■ 解答のポイント',
                ...
                <QuestionTemp4
                    ...
                    :contents="[
                        // 問６
                        {
                            ...
                            answer: '24,120',
                            questionTitle: '複利計算',
                            relatedProblems: ['2022a6', '2022b6', '2022c6'],
                            explanation: [
                                {
                                    type: 'blockTitle',
                                    value: '■ 解答のポイント',
                        ...
                        // 問７
                        {
                            ...
                            relatedProblems: ['2022a7', '2022b7', '2022c7'],
                            explanation: [
                                {
                                    type: 'blockTitle',
                                    value: '■ 解答のポイント',
                        ...
                        // 問８
                        {
                            ...
                            answer: '1.51',
                            questionTitle: '実利率',
                            relatedProblems: ['2022a8', '2022b8', '2022c8'],
                            explanation: [
                                {
                                    type: 'blockTitle',
                                    value: '■ 解答のポイント',
                        ...
                        // 問９
                        {
                            ...
                            relatedProblems: ['2022a9', '2022b9', '2022c9'],
                            explanation: [
                                {
                                    type: 'blockTitle',
                                    value: '■ 解答のポイント',
                        ...
                        // 問10
                        {
                            ...
                            relatedProblems: ['2022a10', '2022b10', '2022c10'],
                            explanation: [
                                {
                                    type: 'blockTitle',
                                    value: '■ 解答のポイント',
                    ...
                    :contents="[
                        ...
                        // 問22
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'result',
                                    value: '▶ 答え 270,322,908千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問23
                        ...
                        // 問24
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価 = 支出現価 より', '469,255P = 282,269,144,000円', 'P = 282,269,144,000円 ÷ 469,255', 'P = 601,526…円'],
                                },
                                {
                                    type: 'result',
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2022a26', '2022b41', '2022c41']"
                    :contents="[
                        // rev: 2026-07-31 確認済み
                        '日本全会社生命表 → 日本三会社生命表', //p12
                        '正しい',
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :relatedProblems="['2022a27', '2022c47']"
                    :contents="[
                        // rev: 2026-07-12 確認済み
                        '正しい',
                        '実質的に標準責任準備金の概念に沿っていた → 必ずしも標準責任準備金の概念に沿ってはいなかった', //p99
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2022a29', '2022b29', '2022c29']"
                    :contents="[
                        // rev: 2026-07-16 確認済み
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2022a30', '2022b49']"
                    :contents="[
                        // rev: 2026-07-20 確認済み
                        '正しい',
                        '正しい',
                        '保険金は契約当初の基本保険金額を基準として積立金の変動に応じて[[毎月]]変動させる。', //p148
                    ]"
                />
                <QuestionTemp2
                    :questionNumber="31"
                    ...
                    :items="[
                        ...
                        {
                            // rev: 2026-07-25 確認済み
                            relatedProblems: ['2022a34', '2022c26'],
                            questionTitle: '計算基礎の変化と純保険料の変化',
                            content: '予定死亡率を低く、予定利率を高くすると、定期保険と養老保険の純保険料は[[低くなる]]。', //p53
                        }, //34
                        {
                            // rev: 2026-07-11 確認済み
                        ...
                        {
                            // rev: 2026-07-25 確認済み
                            relatedProblems: ['2022a37', '2022c43'],
                        ...
                        }, //39
                        {
                            ...
                            questionTitle: '団体定期保険の配当',
                            content: '正しい',
                        }, //40
                        {
                            // rev: 2026-07-11 確認済み
                            relatedProblems: ['2022a41', '2022b42', '2022c31'],
                        ...
                        {
                            // rev: 2026-07-11 確認済み
                            relatedProblems: ['2022a43', '2022c16'],
                        ...
                        {
                            // rev: 2026-07-11 確認済み
                            relatedProblems: ['2022a44', '2022b36'],
                            questionTitle: '責任準備金',
                            label: 'エ',
                            content: '予定利率',
                        }, //44
                        ...
                        {
                            // rev: 2026-07-11 確認済み
                            relatedProblems: ['2022a46', '2022b46', '2022c46'],
            ...
            <TestNavigationButtons previous-route="keiri2023c" next-route="keiri2022b" />
        </section>
    </SeihoTestLayout>
</template>
