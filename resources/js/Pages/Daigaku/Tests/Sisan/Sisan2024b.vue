        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-06-29 確認済み
                        '原則として[[1,000円以上1,000円単位]]の積立制度であある。', //p27
                        '正しい',
                        '10年 → ５年', //p29
                        '「財産形成非課税住宅貯蓄申告書」は財形住宅貯蓄を申し込む際に提出する。「財産形成非課税住宅貯蓄申告書」の最高限度額の範囲内の金額から生じる[[利息]]等については、[[非課税の取扱い]]となる。', //p30
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="8"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '500万円 → 1,000万円', //p129
                        '国内で証券業を営む証券会社（外国証券会社はその在日支店）には、すべて日本投資者保護基金への[[加入義務がある]]。', //p129
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="13"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-06-29 確認済み
                        '単純平均株価には、株式分割や権利落ちなどによる株価への影響が[[修正されていない]]など株価の連続性が[[保たれていない]]という欠点がある。', //p56
                        '正しい',
                        '正しい',
                        '正しい',
                    ]"
            ...
            <TestNavigationButtons previous-route="daigaku.sisan2024a" next-route="daigaku.sisan2024c" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
