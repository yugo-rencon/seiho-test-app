            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '低率 → 高率', //p47
                        '生活習慣病特約での糖尿病入院発生率が[[著しく高い]]。', //p51-52
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '欧米では[[社医制度はなく、一般に嘱託医だけである]]。', //p95
                        '3項目 → 2項目（検診（検診書）は含まない）', //p99
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '正しい',
                        '取扱いが簡単である点にメリットがあるが、[[元受会社にとっては危険に関係のない責任準備金部分まで再保険料を支払わなければならない]]。', //p179
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '正しい',
                        '保険法には告知義務者を定めているが、[[告知の相手方についての明文はない]]。', //p13
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '覚せい剤、麻薬の中毒者については、[[治癒後も長く保険契約を受理しない]]ことが通例である。', //p59
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="29"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '契約確認は[[一部]]の契約について契約成立前に行い，[[大部分]]は契約成立後に行うのが実情である。', //p113-114
                        '正しい',
                        '正しい',
                    ]"
                />
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //33
                        {
                            ...
                            content: '血圧は心臓の動きにつれて規則的に変化し、心臓が収縮するときに最も高く、拡張するときに最も低くなる。収縮期に相当する血圧を[[最大血圧]]、拡張期のそれを[[最小血圧]]と呼ぶ。', //p64
                        }, //34
                        {
                            // rev: 2026-07-04 確認済み
