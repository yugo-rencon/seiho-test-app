        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-09-02 確認済み
                        '減価償却費や税金等は、生命保険会社の損益計算書上では、[[事業費には含まれない]]。', //p173
                        '正しい',
                        '「事業費管理」は、通常、経営管理手法のひとつである[[予算]]制度を活用した事業費[[予算]]管理制度として行われている。', //p176
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="26"
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //35
                        {
                            // rev: 2026-09-02 確認済み
                            questionTitle: '負債勘定',
                            content: '一般の企業では、流動（短期）負債に属する負債、固定（長期）負債に属する負債に区分することになっているが、生命保険会社は、契約者に対する保険契約準備金が大部分を占めるため、[[一般の企業とは違った区分をしている]]。', //p125
                        }, //36
                        {
                            // rev: 2026-09-02 確認済み
                            questionTitle: '損益の算定',
            ...
            <TestNavigationButtons previous-route="kaikei2023a" next-route="kaikei2023c" />
        </section>
    </SeihoTestLayout>
</template>
