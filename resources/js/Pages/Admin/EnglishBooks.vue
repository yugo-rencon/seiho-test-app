...
const visibleBooks = computed(() => props.books.filter((book) => (filter.value === "all" || book.status === filter.value) && (genreFilter.value === "all" || book.genre === genreFilter.value)));
