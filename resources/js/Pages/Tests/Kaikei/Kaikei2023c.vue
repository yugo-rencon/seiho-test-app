...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                                :items="[
                    // 問31〜40
                    { label: '解', content: '株主実体の公準ではなく、企業実体の公準' }, //31
                    { label: '解', content: '正しい' }, //32
                    { label: '解', content: '正しい' }, //33
                    { label: '解', content: '正しい' }, //34
                    { label: '解', content: '正しい' }, //35
                    { label: '解', content: '法人税法上の貸倒引当金として認められる額を超える額は、損金に算入されない。' }, //36
                    { label: '解', content: 'こども保険等の生存保険金および個人年金における死亡返戻金等は「給付金」として処理される。' }, //37
                    { label: '解', content: '会社法施行規則ではなく、保険業法施行規則。' }, //38
                    { label: '解', content: '正しい' }, //39
                    { label: '解', content: '会計監査人は、株主総会（相互会社にあっては総代会）により選任され、その職務は会社の行う一切の会計行為が、会社法，保険業法等の法令に準拠して適正に行われているか否かについて監査を行い、その結果を取締役および監査役に報告することにある。' }, //40
                    // 問41〜50
