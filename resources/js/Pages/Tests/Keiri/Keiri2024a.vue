        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                    ...
                    :contents="[
                        ...
                        // 問２
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'text',
                                    value: '「10年後に何人残るか」は、今の人数に“10年間生き残る割合（生存率）を掛けることで求める。',
                                },
                                {
                                    type: 'blockTitle',
                                    value: '■ 使用する公式',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['65歳の生存数 ÷ 55歳の生存数', '＝ 88,751 ÷ 94,704', '＝ 0.937140'],
                                },
                                {
                                    type: 'text',
                                    value: '② 10年後の生存者数',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['基準年齢（55歳）の人数 × 生存率', '＝ 100,000 × 0.937140 ＝ 93,714.0'],
                                },
                                {
                                    type: 'result',
                        ...
                        // 問５ p39
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['純保険料', '＝ 必要な現価（問４の解） ÷ 50歳男子の年始生存者数', '＝ 1,368,176千円 ÷ 96,319人', '＝ 14,204円'],
                                },
                                {
                                    type: 'result',
                        ...
                        // 問21
                        {
                            ...
                            explanation: [
                                ...
                                },
                                {
                                    type: 'formulaBlock',
                                    value: [
                                        '41歳：4,000千円 × 126 × 0.995037 ＝ 501,499千円',
                                        '42歳：4,000千円 × 137 × 0.985185 ＝ 539,881千円',
                                        '43歳：4,000千円 × 147 × 0.975431 ＝ 573,553千円',
                                        '44歳：4,000千円 × 159 × 0.965773 ＝ 614,232千円',
                                        '45歳：4,000千円 × 172 × 0.956211 ＝ 657,873千円',
                                    ],
                                },
                                {
                                    type: 'text',
                        ...
                        // 問24
                        {
                            ...
                            explanation: [
                                ...
                                },
                                {
                                    type: 'formulaBlock',
                                    value: [
                                        '41歳：P × 97,936 × 1.000000 = 97,936P',
                                        '42歳：P × 97,810 × 0.990099 = 96,842P',
                                        '43歳：P × 97,673 × 0.980296 = 95,748P',
                                        '44歳：P × 97,525 × 0.970590 = 94,657P',
                                        '45歳：P × 97,366 × 0.960980 = 93,567P',
                                    ],
                                },
                                {
                                    type: 'formulaBlock',
                ...
                <QuestionTemp1
                    ...
                    :subject="subject"
                    :contents="[
                        //p96 (2024-A-28,2024-B-28,2024-C-28,2023-C-28)
                ...
                <QuestionTemp1
                    ...
                    :subject="subject"
                    :contents="[
                        //p119 (2024-A-29,2024-B-29,2024-C-29)
                        '正しい',
                        '正しい',
