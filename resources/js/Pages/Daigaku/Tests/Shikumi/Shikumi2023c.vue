...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '保険期間が1年以下のときはクーリング・オフができる → クーリング・オフはできない', //p8
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="2"
                    ...
                    :relatedProblems="['2023a2', '2023a41', '2023b2', '2023c2']"
                    :contents="[
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023b3', '2023c3']"
                    :contents="[
                        '商法 → 保険法', //p25
                        '自殺に該当する → 自殺に該当しない', //p27
                        '故意と判断され、保険金は支払われない → 故意とは判断されず、保険金が支払われる', //p27
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023c4']"
                    :contents="[
                        '保険契約は失効しない → 失効する', //p34
                        '正しい',
                        '解約返戻金の請求権は消滅する → 存続する', //p35
                        '失効中の期間は計算対象に含まれない → 含めて計算する', //p36
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="5"
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023a6', '2023b6', '2023c6']"
                    :contents="[
                        '収支相等の原則が有効に機能していること → 大数の法則が作用し得る程度に十分大量の被保険者が存在すること', //p67
                        '厚生労働省 → 金融庁長官', //p67
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023b18', '2023c7']"
                    :contents="[
                        '元利金を差し引く前の金額 → 元利金を差し引いた残額', //p114
                        '正しい',
                        '元利金を差し引く前の金額 → 元利金を差し引いた残額', //p115
                        '保険契約が継続 → 減額部分は解約<br>解約返戻金は支払われない → 支払われる', //p118
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="8"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        '診査は不要 → 診査は必要<br>契約時年齢で計算 → 手続時の年齢で計算', //p120
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023a25', '2023b13', '2023c11']"
                    :contents="[
                        '財務大臣 → 内閣総理大臣', //p3
                        '免許制 → 登録制', //p3
                        '正しい',
                        '記名押印は行われていない → 記名押印による同意確認を行なっている', //p5
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="12"
                    ...
                    :relatedProblems="['2023b1', '2023c12']"
                    :contents="[
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        '正しい',
                        '正しい',
                        '海外の比較的低い金利で予定利率を低く設定 → 比較的高い金利で予定利率を高く設定', //p152
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023b12', '2023c15']"
                    :contents="[
                        '正しい',
                        '無告知で → 告知が必要', //p137
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023a17', '2023b17', '2023c17', '2023c41']"
                    :contents="[
                        '契約後の経過期間ごとの解約発生率に影響 → 医学的な法則に従った死亡率に影響', //p56
                        '正しい',
                        '正しい',
                        '正しい',
                    ]"
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023a13', '2023b21', '2023c18']"
                    :contents="[
                        '正しい',
                        '災害入院特約 → 家族型入院特約', //p157
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :subject="subject"
                    questionTitle="損害保険"
                    :relatedProblems="['2023a12', '2023c20']"
                    :contents="[
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023a5', '2023c21']"
                    :contents="[
                        '正しい',
                        '解除権を行使することができる → 行使できない', //p40
                        '正しい',
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="危険選択上、被保険者集団が具備すべき条件"
                    :relatedProblems="['2023c23']"
                    :contents="[
                        '正しい',
                        '正しい',
                        '危険度の高い契約 → 危険度の低い契約', //p66
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp3
                    ...
                    :relatedProblems="['2023a1', '2023c25']"
                    :contents="[
                        '傷害疾病定額保険契約',
                        '無効',
                        '片面的強行規定',
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        {
                            questionTitle: '復活時の責任開始期',
                            relatedProblems: ['2023c43'],
                            content: '復活の請求があった日 →復活の請求書や告知書に基づき生命保険会社が復活を承諾した後、延滞保険料の払込みがあった日',
                        }, //43 p36
                        {
                            questionTitle: '年払・半年払保険料の取扱い',
                            relatedProblems: ['2023b43', '2023c44'],
                            content: '支払うことはない → 支払う',
                        }, //44 p44
                        {
                            questionTitle: '剰余金の主な源泉',
                            relatedProblems: ['2023c45'],
                            content: '予定死亡率 ↔︎ 実際死亡率',
                        }, //45 p103
                        {
                        ...
                        {
                            questionTitle: '低解約返戻金型生命保険',
                            relatedProblems: ['2023c47'],
                            content: '保険料払込満了後 ↔︎ 保険料払込中',
                        }, //47 p152
                        {
                            questionTitle: '保険契約の解除請求者',
                            relatedProblems: ['2023c48'],
                            content: '保険会社に対して → 保険契約者に対して',
                        }, //48 p43
                        {
            ...
            <TestNavigationButtons previous-route="daigaku.shikumi-kojin2023b" next-route="daigaku.shikumi-kojin2022a" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
