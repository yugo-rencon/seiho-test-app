        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="女性の公的年金（国民年金）に係る種別変更等"
                    :relatedProblems="[]"
                    :contents="[
                        '', //p
                        '', //p
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="雇用保険の給付と公的年金との調整等"
                    :relatedProblems="[]"
                    :contents="[
                        '', //p
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="健康保険の任意継続被保険者と一般被保険者との違い・特徴（協会けんぽ）"
                    :relatedProblems="[]"
                    :contents="[
                        '', //p
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="産前産後休業期間および育児休業期間中の厚生年金保険料"
                    :relatedProblems="[]"
                    :contents="[
                        '正しい',
                        '', //p
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        {
                            // rev: 2026-08-23 確認済み
                            questionTitle: 'ケアマネジャー',
                            relatedProblems: [],
                            content: '正しい',
                        }, //46
                        {
                            questionTitle: '短時間労働者等の取扱い',
                            relatedProblems: [],
                            content: '', //p
                        }, //47
                        {
                            // rev: 2026-08-23 確認済み
                            questionTitle: '年金請求書の受付',
                            relatedProblems: [],
                            content: '正しい',
                        }, //48
                        {
            ...
            <TestNavigationButtons previous-route="daigaku.syakai2025c" next-route="daigaku.syakai2024b" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
