...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <TestNavigationButtons previous-route="daigaku.kigyo2024c" next-route="daigaku.kigyo2023b" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
