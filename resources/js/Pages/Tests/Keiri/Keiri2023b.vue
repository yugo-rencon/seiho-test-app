        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                    ...
                    :contents="[
                        ...
                        // 問３ p10
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['12.94 + 15.15 + 8.63 + 3.56 + 1.42 = 45.15'],
                                },
                                {
                                    type: 'text',
                                    value: '③ 109歳の平均余命',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['109歳～113歳の延べ生存年数の合計 ÷ 109歳の生存者数', '= 45.15 ÷ 44.172', '= 1.022…'],
                                },
                                {
                                    type: 'result',
                    ...
                    :contents="[
                        // 問21
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金：200万円 = 2,000千円', '保険期間：5年（50〜54歳）', '支払い：年央（期央）と仮定'],
                                },
                                {
                                    type: 'text',
                                    value: '① 各年齢の死亡保険金現価',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['50歳：2,000千円 × 192 × 0.995037 = 382,094千円', '51歳：2,000千円 × 205 × 0.985185 = 403,926千円', '52歳：2,000千円 × 219 × 0.975431 = 427,239千円', '53歳：2,000千円 × 234 × 0.965773 = 451,982千円', '54歳：2,000千円 × 248 × 0.956211 = 474,281千円'],
                                },
                                {
                                    type: 'text',
                                    value: '② 合計',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金現価の合計', '= 382,094 + 403,926 + 427,239 + 451,982 + 474,281', '= 2,139,522千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 2,139,522千円',
                                },
                            ],
                        },
                        // 問22
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：200万円 = 2,000千円', '5年後（55歳）の生存数：96,441人', '5年の期末払現価率：0.951466'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['満期保険金の現価', '= 96,441 × 2,000 × 0.951466', '= 183,520,665.012千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 183,520,665千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問23
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：200万円 = 2,000千円', '予定事業費：保険金1000円につき25円 = 25 ÷ 1000', '50歳の生存数：97,539人'],
                                },
                                {
                                    type: 'text',
                                    value: '① 1人あたりの予定事業費',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['= 50千円 × 97,539人', '= 4,876,950千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 4,876,950千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問24
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金の現価（問21）= 2,139,522千円', '満期保険金の現価（問22）= 183,520,665千円', '予定事業費の現価（問23）= 4,876,950千円'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['支出現価', '= 2,139,522 + 183,520,665 + 4,876,950', '= 190,537,137千円 = 190,537,137,000円'],
                                },
                                {
                                    type: 'text',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価 = 支出現価 より', '476,137P = 190,537,137,000円', 'P = 190,537,137,000円 ÷ 476,137', 'P = 400,172…円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 400,170円（10円未満四捨五入）',
                                },
                            ],
                        },
                    ]"
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2023b28']"
                    :contents="[
                        // rev: 2026-07-14 確認済み
                        '延長保険は、払済保険とは対照的に死亡保障に重点を置いて死亡保険金額は変わらないが、保険期間が短くなることもあり、満期時に受け取る保険金も[[ゼロまたは少額になる]]。', //p114
                        '正しい',
                        '正しい',
                    ]"
                />
            ...
            <TestNavigationButtons previous-route="keiri2023a" next-route="keiri2023c" />
        </section>
    </SeihoTestLayout>
</template>
