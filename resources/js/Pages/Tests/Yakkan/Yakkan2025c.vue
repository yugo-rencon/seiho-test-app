...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-[#fdfbff] text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        'かつては生命保険と損害保険の区別は[[商法でのみ定義されていた]]。', //p204
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="24"
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //34
                        {
                            ...
                            content: '「保険契約の締結の[[媒介]]」とは保険契約の成立に尽力する事実行為であるのに対し、「保険契約の締結の[[代理]]」とは保険契約の締結そのものと考えてよい。', //p47
                        }, //35
                        {
                            // rev: 2026-08-10 確認済み
                            questionTitle: '特約の消滅',
                        ...
                        }, //38
                        {
                            ...
                            content: '外国保険業者の場合は、[[株式会社や相互会社でなくてもよく]]、個人でもよい。', //p257
                        }, //39
                        {
                            // rev: 2026-08-10 確認済み
                            questionTitle: '乗合の禁止',
            ...
            <!-- ボタングループ -->
            <TestNavigationButtons previous-route="yakkan2025b" next-route="yakkan2024a" />
        </section>
    </SeihoTestLayout>
</template>
