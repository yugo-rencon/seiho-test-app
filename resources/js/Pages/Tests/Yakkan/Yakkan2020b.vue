        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-08-20 確認済み
                        '相互会社は、[[他の相互会社または保険株式会社と合併をすることができる]]。', //p252
                        '正しい',
                        '保険法 → 会社法', //p252
                    ]"
                />
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '保険期間満了後の入院についても、[[特約の保険期間中の入院とみなす]]。', //p175
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="30"
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //34
                        {
                            ...
                            content: '住所変更通知義務は、保険契約者がこの義務を履行しなかったときに、民法上の債務不履行に関する一般原則を適用する性質を[[有するものではなく]]、単に、保険契約者が不利益を被る結果になるのにすぎないものである。', //p109
                        }, //35
                        {
                            // rev: 2026-08-14 確認済み
                            questionTitle: '契約者貸付',
            ...
            <TestNavigationButtons previous-route="yakkan2020a" next-route="yakkan2020c" />
        </section>
    </SeihoTestLayout>
</template>
