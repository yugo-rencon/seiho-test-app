        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-08-21 確認済み
                        '10年チルメル式 → 平準純保険料式', //p242
                        '正しい',
                        '3つの区分 → 4つの区分（保険料積立金・未経過保険料・[[払戻積立金]]・[[危険準備金]]）', //p243
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="25"
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //31
                        {
                            ...
                            relatedProblems: ['2023b32'],
                            content: '正しい',
                        }, //32
                        {
                            // rev: 2026-08-13 確認済み
                            questionTitle: '団体扱特約',
                            relatedProblems: ['2023b33'],
                            content: '正しい',
                        }, //33
                        {
                            // rev: 2026-08-13 確認済み
            ...
            <TestNavigationButtons previous-route="yakkan2023a" next-route="yakkan2023c" />
        </section>
    </SeihoTestLayout>
</template>
