...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 text-gray-800 py-10">
                    ...
                    :contents="[
                        // 問21
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['50歳：3,000千円 × 275 × 0.995037 = 820,906千円', '51歳：3,000千円 × 299 × 0.985185 = 883,711千円', '52歳：3,000千円 × 323 × 0.975431 = 945,193千円', '53歳：3,000千円 × 347 × 0.965773 = 1,005,370千円', '54歳：3,000千円 × 372 × 0.956211 = 1,067,131千円'],
                                },
                                {
                                    type: 'text',
                                    value: '② 合計',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金現価の合計', '= 820,906 + 883,711 + 945,193 + 1,005,370 + 1,067,131', '= 4,722,311千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 4,722,311千円',
                                },
                            ],
                        },
                        // 問22
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：300万円 = 3,000千円', '5年後（55歳）の生存数：94,704人', '5年の期末払現価率：0.951466'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['満期保険金の現価', '= 94,704 × 3,000 × 0.951466', '= 270,322,908.192千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 270,322,908千円（千円未満を四捨五入）',
                                },
                            ],
                        },
                        // 問23
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：300万円 = 3,000千円', '予定事業費：保険金1000円につき25円 = 25 ÷ 1000', '50歳の生存数：96,319人'],
                                },
                                {
                                    type: 'text',
                                    value: '① 1人あたりの予定事業費',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['= 75千円 × 96,319人', '= 7,223,925千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 7,223,925千円（千円未満を四捨五入）',
                                },
                            ],
                        },
                        // 問24
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['50歳：P × 96,319 × 1.000000 = 96,319P', '51歳：P × 96,045 × 0.990099 = 95,094P', '52歳：P × 95,746 × 0.980296 = 93,859P', '53歳：P × 95,423 × 0.970590 = 92,617P', '54歳：P × 95,076 × 0.960980 = 91,366P'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価の合計', '= 96,319P + 95,094P + 93,859P + 92,617P + 91,366P', '= 469,255P'],
                                },
                                {
                                    type: 'text',
                                    value: '② 支出現価（問21〜23より）',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金の現価（問21）= 4,722,311千円', '満期保険金の現価（問22）= 270,322,908千円', '予定事業費の現価（問23）= 7,223,925千円'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['支出現価', '= 4,722,311 + 270,322,908 + 7,223,925', '= 282,269,144千円 = 282,269,144,000円'],
                                },
                                {
                                    type: 'text',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価 = 支出現価 より', '469,255P = 282,269,144,000円', 'P = 282,269,144,000円 ÷ 469,255', 'P = 601,526円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 601,530円（10円未満四捨五入）',
                                },
                            ],
                        },
                        // 問25
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //36
                        {
                            ...
                            questionTitle: '責任準備金',
                            content: 'すべての契約について累積額が増加するわけではなく、定期保険などのように、[[保険期間の後半]]にその年度の残額がマイナスになる場合もあることに注意が必要である。', //p65
                        }, //37
                        {
                            // rev: 2026-07-10 確認済み
            ...
            <TestNavigationButtons previous-route="keiri2024a" next-route="keiri2024c" />
        </section>
    </SeihoTestLayout>
</template>
