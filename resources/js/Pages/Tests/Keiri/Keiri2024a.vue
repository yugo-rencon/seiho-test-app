        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                    ...
                    :contents="[
                        // 問１
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['生存率（45歳 → 50歳）', '= 50歳の生存数 ÷ 45歳の生存数', '= 96,319 ÷ 97,336 = 0.989246'],
                                },
                                {
                                    type: 'result',
                        ...
                        // 問２
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['基準年齢（55歳）の人数 × 生存率（55歳 → 65歳）', '= 100,000 × 88,751 ÷ 94,704 = 93,714.0'],
                                },
                                {
                                    type: 'result',
                        ...
                        // 問３
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['105歳：30.877 × 0.5 = 15.44', '106歳：13.8961 × 1.5 = 20.84', '107歳：5.6633 × 2.5 = 14.16', '108歳：2.0682 × 3.5 = 7.24', '109歳：0.9156 × 4.5 = 4.12'],
                                },
                                {
                                    type: 'text',
                                    value: '② 105歳～109歳の延べ生存年数の合計',
                                },
                                {
                                    type: 'note',
                                    value: '105歳以上の全員が、合計で何年分生きたかを合算する。',
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['15.44 + 20.84 + 14.16 + 7.24 + 4.12 = 61.8'],
                                },
                                {
                                    type: 'text',
                                    value: '③ 105歳の平均余命',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['105歳～109歳の延べ生存年数の合計 ÷ 105歳の生存者数', '= 61.8 ÷ 53.420', '= 1.156'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 1.16（小数第3位を四捨五入）',
                                },
                            ],
                        },
                        // 問４
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金（500万円） × 死亡数（50歳）', '= 5,000千円 × 275人', '= 1,375,000千円'],
                                },
                                {
                                    type: 'text',
                                    value: '② 現価（年央払）',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['合計保険金額 × 期央払現価率（利率1.0%）', '= 1,375,000千円 × 0.995037', '= 1,368,175.8千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え：1,368,176千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問５ p39
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['純保険料', '= 必要な現価（問４の解） ÷ 50歳の年始生存者数', '= 1,368,176千円 ÷ 96,319人', '= 14,204円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 14,200円（10円未満四捨五入）',
                                },
                            ],
                        },
                    ]"
                    ...
                    :contents="[
                        ...
                        // 問10
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'text',
                                    value: '将来500万円を得るために、今いくら必要かを求める問題。将来価値がわかっているので、複利を逆算（割り戻す）して現在価値を求める。',
                                },
                                {
                                    type: 'blockTitle',
                                    value: '■ 使用する公式',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['将来価値：5,000,000円', '年利率：1.6％ = 0.016', '期間：5年'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['現在価値', '= 5,000,000 ÷ (1 + 0.016)<sup>5</sup>', '= 5,000,000 ÷ 1.082608…', '= 4,618,506.8…'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 4,618,507円（円未満四捨五入）',
                                },
                            ],
                        },
                    ]"
                    ...
                    :contents="[
                        // 問21
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金：400万円 = 4,000千円', '保険期間：5年（41〜45歳）', '支払い：年央（期央）と仮定'],
                                },
                                {
                                    type: 'text',
                                    value: '① 各年齢の死亡保険金現価',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['41歳：4,000千円 × 126 × 0.995037 = 501,499千円', '42歳：4,000千円 × 137 × 0.985185 = 539,881千円', '43歳：4,000千円 × 147 × 0.975431 = 573,553千円', '44歳：4,000千円 × 159 × 0.965773 = 614,232千円', '45歳：4,000千円 × 172 × 0.956211 = 657,873千円'],
                                },
                                {
                                    type: 'text',
                                    value: '② 合計',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金現価の合計', '= 501,499 + 539,881 + 573,553 + 614,232 + 657,873', '= 2,887,038千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 2,887,038千円',
                                },
                            ],
                        },
                        // 問22
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：400万円 = 4,000千円', '5年後（46歳）の生存数：97,194人', '5年の期末払現価率：0.951466'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['満期保険金の現価', '= 97,194 × 4,000 × 0.951466', '= 369,907,145.616千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 369,907,146千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問23
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：400万円 = 4,000千円', '予定事業費：保険金1000円につき25円 = 25 ÷ 1000', '41歳の生存数：97,936人'],
                                },
                                {
                                    type: 'text',
                                    value: '① 1人あたりの予定事業費',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['= 4,000千円 ×（25 ÷ 1000）', '= 4,000 × 0.025', '= 100千円'],
                                },
                                {
                                    type: 'text',
                                    value: '② 予定事業費の現価（合計）',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['= 100千円 × 97,936人', '= 9,793,600千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 9,793,600千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問24
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['41歳：P × 97,936 × 1.000000 = 97,936P', '42歳：P × 97,810 × 0.990099 = 96,842P', '43歳：P × 97,673 × 0.980296 = 95,748P', '44歳：P × 97,525 × 0.970590 = 94,657P', '45歳：P × 97,366 × 0.960980 = 93,567P'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価の合計', '= 97,936P + 96,842P + 95,748P + 94,657P + 93,567P', '= 478,750P'],
                                },
                                {
                                    type: 'text',
                                    value: '② 支出現価（問21〜23より）',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金の現価（問21）= 2,887,038千円', '満期保険金の現価（問22）= 369,907,146千円', '予定事業費の現価（問23）= 9,793,600千円'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['支出現価', '= 2,887,038 + 369,907,146 + 9,793,600', '= 382,587,784千円 = 382,587,784,000円'],
                                },
                                {
                                    type: 'text',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価 = 支出現価 より', '478,750P = 382,587,784,000円', 'P = 382,587,784,000円 ÷ 478,750', 'P = 799,138.9…円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 799,140円（10円未満四捨五入）',
                                },
                            ],
                        },
                        // 問25
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-20 確認済み
                        '[[保険金比例と保険料比例を組み合わせる方式]]が一般的である。', //p55
                        '正しい',
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2024a30', '2024c47']"
                    :contents="[
                        // rev: 2026-07-20 確認済み
                        '正しい',
                        '特別勘定に入った貯蓄保険料部分は積立金として運用され、積立金は[[毎日の運用実績]]（評価損益を含む総合収益）によって計算される特別勘定指数（インデックス）またはユニット価格の変化に応じて[[毎日変動する]]。', //p148
                        '正しい',
                    ]"
                />
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        {
                            // rev: 2026-07-25 確認済み
                            relatedProblems: ['2024a35', '2024a43'],
                            questionTitle: '責任準備金積立根拠',
                            content: '保険料が自然保険料方式で計算されている場合には、[[平準保険料方式と異なり]]、毎保険年度末に将来の保険金支払いに備えて[[責任準備金を積み立てる必要はない]]。', //p68
                        }, //35
                        {
                            // rev: 2026-07-09 確認済み
                        ...
                        }, //39
                        {
                            ...
                            content: '被保険者ごとの保険料の積み上げがその基礎になっているのに対して、[[配当は、被保険者ごとの配当を算出してそれを積み上げるのではなく、団体単位で計算されている。]]', //p155
                        }, //40
                        {
                            // rev: 2026-07-09 確認済み
                            relatedProblems: ['2024a41', '2024c41'],
            ...
            <TestNavigationButtons next-route="keiri2024b" />
        </section>
    </SeihoTestLayout>
</template>
