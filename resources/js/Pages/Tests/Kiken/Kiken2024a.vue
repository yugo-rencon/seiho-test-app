...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                                :items="[
                    // 問31〜40
                    { label: '解', content: '生命表には国民全体を対象とした<u><b>国民生命表</b></u>と、それよりは小さな特定集団（たとえば生命保険の被保険者集団）を対象とする<u><b>経験生命表</b></u>とがある。' }, //31
                    { label: '解', content: '金額死亡率のほうが件数死亡率よりも事業経営上に与える影響を反映しやすいので、生命保険経営上は、通常、件数死亡率よりも、金額死亡率が多く用いられる。' }, //32
                    { label: '解', content: '正しい' }, //33
                    { label: '解', content: '職業危険には、「職業に伴う災害危険」「いわゆる職業病のような疾病危険」<u><b>さらには「アルコール中毒や不摂生生活のような職業に随伴する危険」がある</b></u>。' }, //34
                    { label: '解', content: '正しい' }, //35
                    { label: '解', content: '一般に嘱託医については、各保険会社とも、診査を可能とする被保険者の年齢や保険金額に限度を設け（診査限度という）、社医と区別しているが、さらに嘱託医の資格別にも診査限度を定めている。' }, //36
                    { label: '解', content: '正しい' }, //37
                    { label: '解', content: '失効後の期間の<u><b>長い</b></u>ものほど逆選択混入の危険が多く、また診査による場合に比べ告知のみによる場合のほうが経験死亡率が高いとされている。' }, //38
