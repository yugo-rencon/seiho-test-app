...
const currentContactPath = computed(() => {
    if (isDaigakuPage.value) return "/daigaku/contact";
    if (isSenmonPage.value) return "/senmon/contact";
    if (isOuyouPage.value) return "/ouyou/contact";
    if (isIppanPage.value) return "/ippan/contact";
    return "/contact";
});
