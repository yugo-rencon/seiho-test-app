        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-04 確認済み
                        '「実体的危険」は、「[[身体的危険]]」と「環境的危険」の２つに分類することができる。', //p4
                        '正しい',
                        '[[環境的危険]]とは、被保険者の生活環境全般に関する危険であるが主に被保険者の職業・仕事の内容による危険を指す。', //p4
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="22"
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '国民の平均入院日数よりも短期 → 国民の平均入院日数よりも長期', //p51
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '正しい',
                        '[[明確な債権債務関係が存在するものとは限らず]]、恩義的あるいは義理的関係などのものも多く、[[道徳的危険が潜在するおそれがある]]。', //p74
                        '「保険会社向けの総合的な監督指針」では、[[法人等の財テクなどを主たる目的とした契約や、当初から短期の中途解約を前提とした契約等の保険本来の趣旨を逸脱するような募集活動を行わないこと]]が求められている。', //p76
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="24"
                    ...
                    :contents="[
                        ...
                        '正しい',
                        'その方法は、[[被保険者、契約者への面談をはじめとし、治療医との面談、診断書の取り寄せ等]]多岐にわたっており、業務担当者には高度の対応技術や医学的知識と迅速な行動が必要とされる。', //p114
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="25"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '[[若年層]]の死亡指数を引き下げることは、[[高齢層]]の死亡指数を引き下げるより困難である。', //p112
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="27"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '正しい',
                        '健康の異常や症状に対する明確な診断は[[必ずしも必要ではない]]。', //p96
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '給付金日額の制限は、これによって[[超過危険を調整することはできない]]が、不当利得の企てに対抗する抑制策としては有効である。', //p155
                    ]"
                />
                <QuestionTemp2
                    :questionNumber="31"
                    ...
                    :items="[
                        ...
                        }, //34
                        {
                            ...
                            content: '無条件の範囲は非喫煙者保険などのリスク細分化保険では[[狭く]]なり、標準下体保険では広くなる。',//p107
                        }, //35
                        {
                            // rev: 2026-07-04 確認済み
