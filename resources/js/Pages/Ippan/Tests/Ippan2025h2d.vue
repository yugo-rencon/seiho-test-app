        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        // 問68〜82
                        { questionTitle: '契約申込み時の実務', label: '', content: '' }, //68
                        { questionTitle: '契約申込み時の実務', label: '', content: '' }, //69
                        { questionTitle: '契約申込み時の実務', label: '', content: '' }, //70
                        { questionTitle: '契約申込み時の実務', label: '', content: '' }, //71
                        { questionTitle: '契約申込み時の実務', label: '', content: '' }, //72
                        { questionTitle: '生命保険の仕組み', label: '', content: '' }, //73
                        { questionTitle: '生命保険の仕組み', label: '', content: '' }, //74
                        { questionTitle: '生命保険の仕組み', label: '', content: '' }, //75
                        { questionTitle: '生命保険の仕組み', label: '', content: '' }, //76
                        { questionTitle: '生命保険の仕組み', label: '', content: '' }, //77
                        { questionTitle: '社会保障制度', label: '', content: '' }, //78
                        { questionTitle: '社会保障制度', label: '', content: '' }, //79
                        { questionTitle: '社会保障制度', label: '', content: '' }, //80
                        { questionTitle: '社会保障制度', label: '', content: '' }, //81
                        { questionTitle: '社会保障制度', label: '', content: '' }, //82
                    ]"
                />
            </div>

            <TestNavigationButtons previous-route="ippan.2025h2c" next-route="ippan.2025h2e" home-route="ippan.index" />
        </section>
    </SeihoTestLayout>
</template>
