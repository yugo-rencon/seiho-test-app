        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2021a13']"
                    :contents="[
                        // rev: 2026-06-29 確認済み
                        '正しい',
                        '[[一定期間据置き後]]、解約手数料なしで換金できるものとして[[定額貯金]]などがある。', //p6
                        '正しい',
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2021a17']"
                    :contents="[
                        // rev: 2026-06-28 確認済み
                        '正しい',
                        '正しい',
                        '海外金利が上昇している場合、一般的に市場金利は[[上昇]]し、債券価格は[[下落]]する。', //p48
                        '正しい',
                    ]"
                />
                <QuestionTemp1
            ...
            <TestNavigationButtons previous-route="daigaku.sisan2022c" next-route="daigaku.sisan2021b" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
