...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                    ...
                    { label: '解', content: '簿記は、企業が行う経済活動（商品の仕入・販売、物品の購入、経費の支払など）を貨幣額で計算し、測定し、記録してその結果を<u><b>株主、債権者などの外部利害関係者</b></u>へ報告するためのものである。' }, //32
                    { label: '解', content: '正しい' }, //33
                    { label: '解', content: '正しい' }, //34
                    { label: '解', content: '正しい' }, //35
                    { label: '解', content: '有形固定資産の種類ごとに、法人税法で選定できる償却の方法が定められている。' }, //36
                    { label: '解', content: '収支相当の原則ではなく、費用収益対応の原則。' }, //37
                    { label: '解', content: '生命保険会社が支払う税金のうち、法人税やそれを基礎として計算される都道府県民税・市町村民税については、原則として当期に生じた剰余金から支払われるべきものであるから、損益計算書上、他の税金と区別して税引前当期剰余から控除する形式で表示される。' }, //38
