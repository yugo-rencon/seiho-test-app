...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-09 確認済み
                        '正しい',
                        'ユニバーサル保険は、保険料を積み立て、[[短期金利]]にスライドする形で利殖した中から死亡保障コストを控除する商品で、[[決済機能を持たない]]。', //p69
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-08 確認済み
                        '[[個人保険分野]]が、最初に機械化された分野である。', //p198-199
                        '正しい',
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //32
                        {
                            ...
                            content: '純保険料 → 営業保険料', //p23
                        }, //33
                        {
                            // rev: 2026-07-09 確認済み
                            questionTitle: '死亡保険',
                            relatedProblems: ['2020a34'],
                            content: '死亡保険には、定期保険、[[終身保険]]、およびその両者を組み合わせた[[定期付終身保険]]がある。', //p31
                        }, //34
                        {
                            // rev: 2026-07-09 確認済み
                            questionTitle: '日本の保険',
                        ...
                        }, //39
                        {
                            ...
                            content:
                                '少額短期保険業は、短期（生保・医療保険で1年以内、損害保険で2年以内）かつ少額保険金額（疾病による死亡保険金[[300万円]]以内、疾病・傷害による入院給付金等80万円以内、損害保険金[[1,000万円]]以内等で、かつ総額1,000万円以下（複数契約合算））の保険のみを引き受ける保険業である。', //p177
                        }, //40
                        {
                            // rev: 2026-07-06 確認済み
                            questionTitle: '危険の種類',
            ...
            <TestNavigationButtons previous-route="souron2021c" next-route="souron2020b" />
        </section>
    </SeihoTestLayout>
</template>
