        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="厚生年金保険の標準報酬（月）額と保険料"
                    :relatedProblems="[]"
                    :contents="[
                        '', //p
                        '', //p
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="健康保険の任意継続被保険者と一般被保険者との違い・特徴（協会けんぽの場合）"
                    :relatedProblems="[]"
                    :contents="[
                        '', //p
                        '', //p
                ...
                <QuestionTemp3
                    ...
                    :subject="subject"
                    questionRange="25〜29"
                    questionTitle="厚生年金保険の適用事業所および加入者（被保険者）"
                    :relatedProblems="[]"
                    :contents="[
                        // rev: 2026-08-23 確認済み
                        'すべて',
            ...
            <TestNavigationButtons previous-route="daigaku.syakai2022a" next-route="daigaku.syakai2022c" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
