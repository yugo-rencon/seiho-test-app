...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '環境的危険とは、被保険者の生活環境全般に関する危険であるが主に[[被保険者の職業・仕事の内容による危険を指す]]。', //p4
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '「健康管理証明書扱（団体）」は、[[従業員が一定数（一般には20～30名）以上で定期健康診断や出勤管理が十分に行われていることを条件としている点]]は、「健康管理証明書扱（個別）」と同じである。一方、[[被保険者で一定数（一般には20名）以上の申込みがある団体扱いであることや、被保険者個々の告知書や健康管理証明書の提出を必要としないこと]]が相違点である。', //p102
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="25"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '死亡率や[[入院給付率]]は、保険年度が進み選択効果が薄れるにつれ上昇するが、[[手術給付率]]はむしろ加入早期のほうが高値である。', //p52
                        '正しい',
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-07-05 確認済み
                        '保険加入のみを目的として設立された団体[[でない]]ことが契約の要件の１つである。', //p169
                        '正しい',
                        '正しい',
                    ]"
                />
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //31
                        {
                            ...
                            content: '[[金額死亡率]]のほうが[[件数死亡率]]よりも事業経営上に与える影響を反映しやすいので、生命保険経営上は、通常、[[件数死亡率]]よりも[[金額死亡率]]が多く用いられる。', //p9
                        }, //32
                        {
                            // rev: 2026-07-04 確認済み
                        ...
                        }, //35
                        {
                            ...
                            content: '契約確認は[[一部]]の契約について契約成立前に行い，[[大部分]]は契約成立後に行うのが実情である。', //p113-114
                        }, //36
                        {
                            // rev: 2026-07-04 確認済み
                            questionTitle: '給付金確認',
            ...
            <TestNavigationButtons previous-route="kiken2024b" next-route="kiken2023a" />
        </section>
    </SeihoTestLayout>
</template>
