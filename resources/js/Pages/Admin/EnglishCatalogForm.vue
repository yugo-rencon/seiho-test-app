...
const form = useForm({ title: props.book?.title || '', author: props.book?.author || '', genre: props.book?.genre || '', cover_url: props.book?.cover_url || '', amazon_url: props.book?.amazon_url || '', cover_image: null, word_count: props.book?.word_count || null, page_count: props.book?.page_count || null });
