...
<QuestionTemp1
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                    ...
                    {questionTitle: '保険金等支払金の計上', content: '各勘定の期間修正を行うべきであるが、生命保険会計では行わず、支払備金・責任準備金で、期間修正を行い発生主義に修正することとしている。' }, //32
                    {questionTitle: '退職給付引当金', content: '正しい' }, //33
                    {questionTitle: '保険業法と会社法', content: '計算規定を中心に株式会社については会社法を準用し、相互会社については保険業法を中心に定めている。' }, //34
                    {questionTitle: '外貨預金の換算', content: '正しい' }, //35
                    {questionTitle: '繰延税金資産', content: '繰延税金資産は、その期の将来減算一時差異および税務上繰越欠損等に法定実効税率を乗じた額となる。なお、繰延税金資産は一時差異等に係る税金相当額が将来回収できる可能性のあるものでなければ、貸借対照表に計上できないことになっている。' }, //36
                    {questionTitle: '自己株式', content: '自己株式は、純資産の部から控除する形式で表示することとされた。' }, //37
                    {questionTitle: '法人税及び住民税', content: '損益計算書上、他の税金と区別して税引前当期剰余から控除する形式で表示される。' }, //38
