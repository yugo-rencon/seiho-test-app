        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                    ...
                    :contents="[
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['将来の目標額：400万円', '年利率：2％', '運用期間：10年', '減債基金係数：0.09133'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['毎年の積立額', '＝ 400万円 × 0.09133', '＝ 365,320円'],
                                },
                                {
                                    type: 'result',
                                    value: '答え：365,320円',
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2024b22', '2024c8']"
                    :contents="[
                        // rev: 2026-06-29 確認済み
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-06-28 確認済み
                        '預金保険制度の対象となる金融機関は、日本国内に本店がある銀行、[[信用金庫]]、[[信用組合]]、[[労働金庫]]、信金中央金庫、[[全国信用協同組合連合会]]、[[労働金庫連合会]]、商工組合中央金庫である。', //p127
                        '預金保険制度に加入している金融機関が取り扱っている金融商品でも、[[預金保険制度の対象となるものとならないものがある]]。', //p127
                        '正しい',
                        '当初の業務範囲は、金融機関の預金等の払戻しについての保険に限定されていたが、1986年以降に業務の拡充が行われ、[[破綻金融機関にかかる合併等に際して、受け皿金融機関などへの資金援助や不良債権の買取り回収などを行うことが付け加えられた]]。', //p126
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="13"
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '「満期一括受取型商品」は、満期時あるいは解約時に確定した利息に対して１回だけ[[20％源泉分離課税]]される。', //p9
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="14"
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '一定期間据置き後、解約手数料なしで[[換金できる]]ものとして[[定額貯金]]などがある。', //p6
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="債券の取引市場"
                    :relatedProblems="['2024c19']"
                    :contents="[
                        // rev: 2026-06-30 確認済み
                        '正しい',
                    ...
                    :items="[
                        {
                            ...
                            relatedProblems: ['2024b40', '2024c40'],
                            content: '正しい',
                        }, //40
                        {
                            // rev: 2026-06-29 確認済み
            ...
            <TestNavigationButtons previous-route="daigaku.sisan2024b" next-route="daigaku.sisan2023a" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
