            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        '正しい',
                        '3分の1ではなく2分の1。',
                        '短期労働者に対する厚生年金保険・健康保険の適用拡大が行われた。', //p
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="23"
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        { questionTitle: '個人情報保護法', content: '既契約者から本人情報の開示を求められた場合には、個人情報保護法により開示が義務付けられている項目・箇所については開示しなければならない。' }, //32
                        ...
                        { questionTitle: '団体就業不能保障保険', content: '入院または医師の指示により自宅療養をし、業務に全く従事できない状態（就業不能状態）が所定の期間を超えて継続した場合に就業不能保険金を支払う保険である。' }, //36
                        ...
                        { questionTitle: '生命保険大学課程', content: 'トータル・ライフ・コンサルタント（TLC）が正しい。' }, //40
                        // 問41〜50
