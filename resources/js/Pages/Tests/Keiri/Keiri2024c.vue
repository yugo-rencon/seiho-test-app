        ...
        <section class="bg-gray-100 text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                    ...
                    :contents="[
                        // 問21
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['55歳：5,000千円 × 400 × 0.995037 = 1,990,074千円', '56歳：5,000千円 × 432 × 0.985185 = 2,128,000千円', '57歳：5,000千円 × 469 × 0.975431 = 2,287,386千円'],
                                },
                                {
                                    type: 'text',
                                    value: '② 合計',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金現価の合計', '= 1,990,074 + 2,128,000 + 2,287,386', '= 6,405,460千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 6,405,460千円',
                                },
                            ],
                        },
                        // 問22
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：500万円 = 5,000千円', '3年後（58歳）の生存数：93,403人', '3年の期末払現価率：0.970590'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['満期保険金の現価', '= 93,403 × 5,000 × 0.970590', '= 453,280,088.850千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 453,280,089千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問23
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['保険金額：500万円 = 5,000千円', '予定事業費：保険金1000円につき25円 = 25 ÷ 1000', '55歳の生存数：94,704人'],
                                },
                                {
                                    type: 'text',
                                    value: '① 1人あたりの予定事業費',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['= 125千円 × 94,704人', '= 11,838,000千円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 11,838,000千円（千円未満四捨五入）',
                                },
                            ],
                        },
                        // 問24
                        {
                            ...
                            explanation: [
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['55歳：P × 94,704 × 1.000000 = 94,704P', '56歳：P × 94,305 × 0.990099 = 93,371P', '57歳：P × 93,873 × 0.980296 = 92,023P'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価の合計', '= 94,704P + 93,371P + 92,023P', '= 280,098P'],
                                },
                                {
                                    type: 'text',
                                    value: '② 支出現価（問21〜23より）',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['死亡保険金の現価（問21）= 6,405,460千円', '満期保険金の現価（問22）= 453,280,089千円', '予定事業費の現価（問23）= 11,838,000千円'],
                                },
                                {
                                    type: 'formulaBlock',
                                    value: ['支出現価', '= 6,405,460 + 453,280,089 + 11,838,000', '= 471,523,549千円 = 471,523,549,000円'],
                                },
                                {
                                    type: 'text',
                                ...
                                {
                                    type: 'formulaBlock',
                                    value: ['収入現価 = 支出現価 より', '280,098P = 471,523,549,000円', 'P = 471,523,549,000円 ÷ 280,098', 'P = 1,683,423円'],
                                },
                                {
                                    type: 'result',
                                    value: '▶ 答え 1,683,420円（10円未満四捨五入）',
                                },
                            ],
                        },
                        // 問25
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2024c27']"
                    :contents="[
                        // rev: 2026-08-05 確認済み
                        '正しい',
                        '利差益は責任準備金に[[比例]]するので、貯蓄性の強い保険、養老保険などについては、契約初期は[[少なく]]、経過年数が長くなるほど[[多く]]なる。', //128
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //43
                        {
                            ...
                            questionTitle: '純保険料の計算式',
                            label: 'エ',
                            content: '（1 + 予定利率）',
                        }, //44
                        {
                            // rev: 2026-07-11 確認済み
                            relatedProblems: ['2024c45'],
                            questionTitle: '払済保険',
                            label: 'ア',
                            content: '養老保険',
                        }, //45
