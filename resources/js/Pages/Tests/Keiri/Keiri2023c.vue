...
<QuestionTemp4
            ...
            <QuestionTemp2
                ...
                :subject="subject"
                                :items="[
                    // 問31〜40
                    { label: '解', content: '生命保険会社では、満x歳を中心に前後6カ月の被保険者に対してx歳の保険料率を適用する「保険年齢方式」を採用している会社と、通常の年齢の数え方と同じ切捨方式（端数月はすべて切り捨てる）である「満年齢方式」を採用している会社がある。' }, //31
                    { label: '解', content: '正しい' }, //32
                    { label: '解', content: '予定利率は、以前は、長期の契約の予定利率を短期の契約よりも低めの、保守的な水準に設定する生命保険会社もあったが、現在では多くの生命保険会社で保険期間によらず<u><b>商品の特性</b></u>に応じて予定利率を定めている。' }, //33
                    { label: '解', content: '正しい' }, //34
                    { label: '解', content: '延長保険は、死亡保障に重点を置いて死亡保険金額は<u><b>変わらない</b></u>が、保険期間が<u><b>短くなる</b></u>こともあり、満期時に受け取る保険金も<u><b>ゼロまたは少額</b></u>になる。' }, //35
                    { label: '解', content: '正しい' }, //36
                    { label: '解', content: '正しい' }, //37
                    { label: '解', content: '経過年数が短い契約については、通常、危険選択の<u><b>効果があり</b></u>、実際死亡率が予定死亡率を<u><b>かなり下回る</b></u>ので死差益は<u><b>多い</b></u>が、経過年数が増すにつれて選択効果が<u><b>薄れ</b></u>、死差益は<u><b>少なく</b></u>なる。' }, //38
