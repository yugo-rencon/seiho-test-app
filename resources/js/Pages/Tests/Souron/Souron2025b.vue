        ...
        <section class="bg-[#fdfbff] text-gray-800 py-10">
            ...
            <div class="max-w-4xl mx-auto mt-4 space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-05-26 確認済み
                        '「少額短期保険業」は、短期（生保・医療保険で1年以内、損害保険で2年以内）かつ少額保険金額（疾病による死亡保険金[[300万円]]以内、疾病・傷害による入院給付金等[[80万円]]以内、損害保険金1,000万円以内等）の保険のみを引き受ける保険業である。', //p177
                        '1500万円以上 → 1000万円以上', //p176
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '企業としても、[[画一的商品を大量生産、低価格で販売する]]という戦略だけでは対応し切れなくなってきた面もあり、[[いかにニーズを先取りし、他に先駆けて新製品を市場に提供できる]]かが、重要な課題となっている', //p184-185
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="26"
            ...
            <!-- ボタングループ -->
            <TestNavigationButtons previous-route="souron2025a" next-route="souron2025c" />
        </section>
    </SeihoTestLayout>
</template>
