...
const subject = "2022年度 8月〜3月実施 フォームA";
const isDraft = false;
</script>
...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        '公共法人 → 人格のない社団', //p74
                        '正しい',
                        '土地などの売却益、預貯金・貸付金などの受取利息などは[[すべて益金となる]]', //p75
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '正しい',
                        '正しい',
                        '相続財産から控除できない → マイナス財産として相続財産から控除することができる', //p44
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="15"
            ...
            <TestNavigationButtons previous-href="/ouyou/2022-h1-b" next-href="/ouyou/2022-h2-b" home-route="ouyou.index" />
        </section>
    </SeihoTestLayout>
</template>
