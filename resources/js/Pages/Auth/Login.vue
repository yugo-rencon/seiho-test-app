...
const siteUi = computed(() => {
    const styles = {
        seiho: {
            ...
            textLinkClass: "text-purple-700 hover:text-purple-800",
        ...
        daigaku: {
            ...
            textLinkClass: "text-blue-700 hover:text-blue-800",
        ...
        ippan: {
            ...
            textLinkClass: "text-fuchsia-700 hover:text-fuchsia-800",
        ...
        senmon: {
            ...
            textLinkClass: "text-emerald-700 hover:text-emerald-800",
        ...
        ouyou: {
            ...
            textLinkClass: "text-amber-700 hover:text-amber-800",
