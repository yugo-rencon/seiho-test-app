...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        ...
                        '日経平均株価の構成銘柄は、市場流動性や業種のバランスなどを考慮して、[[毎年定期的]]に見直しを行っている。', //p56
                        '正しい',
                        '株式相場が上昇傾向のときは売買高、売買代金とも[[増加]]傾向を示すことが多く、逆に相場が下落傾向のときは売買高、売買代金とも[[減少]]傾向を示すことが多い。', //p57
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="8"
                ...
                <QuestionTemp1
                    ...
                    :contents="[
                        // rev: 2026-06-29 確認済み
                        '正しい',
                        '利息が非課税になる税制の[[優遇措置はなく]]、一律20％源泉分離課税となっている。', //p28
                        '正しい',
                        '正しい',
                    ]"
                />
            ...
            <TestNavigationButtons previous-route="daigaku.sisan2025c" next-route="daigaku.sisan2024b" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
