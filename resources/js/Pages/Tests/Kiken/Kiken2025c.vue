...
<template>
    <SeihoTestLayout :title="title">
        <section class="bg-[#fdfbff] text-gray-800 py-10">
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //38
                        {
                            ...
                            content: '最高保険金額は年齢、職業、既往歴などによって[[異なっている]]のが一般的である。', //p181
                        }, //39
                        {
                            // rev: 2026-07-04 確認済み
            ...
            <!-- ボタングループ -->
            <TestNavigationButtons previous-route="kiken2025b" next-route="kiken2024a" />
        </section>
    </SeihoTestLayout>
</template>
