        ...
        <section class="bg-gray-100 py-10 text-gray-800">
            ...
            <div class="mx-auto mt-4 max-w-4xl space-y-2">
                ...
                <QuestionTemp4
                    ...
                    :relatedProblems="[['2025a3', '2025b3', '2025c3']]"
                    :labels="['ア']"
                    :contents="[
                        {
                            // rev: 2026-06-27 作成
                ...
                <QuestionTemp4
                    ...
                    :relatedProblems="[['2025a4', '2025b4', '2025c4']]"
                    :labels="['イ']"
                    :contents="[
                        {
                            // rev: 2026-06-28 作成
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2025a8', '2025c8']"
                    :contents="[
                        // rev: 2026-06-28 確認済み
                        '配当利回り → 配当性向', //p58
                        '配当性向 → 配当利回り', //p58
                        '正しい',
                        'ＲＯＥ（自己資本利益率） → ＰＢＲ（株価純資産倍率）', //p59
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="9"
                    ...
                    :subject="subject"
                    questionTitle="投資信託"
                    :relatedProblems="['2025b20', '2025c9']"
                    :contents="[
                        // rev: 2026-06-29 確認済み
                        '投資信託は、１人の個人投資家の「[[小口購入]]」した資金を集めることによって、機関投資家（生命保険会社等）と同じ「[[分散投資]]」の効果を得ることができる。', //p73
                        '正しい',
                        '専門家が運用する場合であっても、最終的にはそのファンドに組み入れられている株式等の有価証券の相場動向が、ファンドの収益性を大きく左右することから、[[必ずしも高い運用実績を得られるとは限らない]]点に注意が必要である。', //p73
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2025a10', '2025c11']"
                    :contents="[
                        // rev: 2026-06-28 確認済み
                        '預けたお金を外貨のまま現金（キャッシュ）で引き出すことは可能だが、[[手数料がかかる]]（手数料は金融機関により異なる）。', //p111
                        '正しい',
                        'ドル建ての預金をユーロ等に振り替えるなど別の通貨に換える場合は、基本的にはいったん円に戻すことになるので、[[〔ドル→円→ユーロ〕と通貨変更のたびに為替手数料が必要になる]]。', //p111
                        '外貨預金は預金保険制度の対象[[外]]商品になる。', //p111
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="12"
                    ...
                    :subject="subject"
                    questionTitle="外国債券"
                    :relatedProblems="['2025a11', '2025b22', '2025c12']"
                    :contents="[
                        // rev: 2026-06-28 確認済み
                        'ショーグン債 → サムライ債', //p122
                        'サムライ債 → ショーグン債', //p122
                ...
                <QuestionTemp1
                    ...
                    :title="title"
                    :subject="subject"
                    questionTitle="金融商品の利払型商品と満期一括受取型商品"
                    :relatedProblems="['2025b13', '2025c13']"
                    :contents="[
                        // rev: 2026-06-29 確認済み
                        '正しい',
                        '正しい',
                        '預入期間、３年以上のスーパー定期（半年複利型）では、[[個人に限って]]満期一括受取型を選択できる。', //p6
                        '正しい',
                    ]"
                />
                <QuestionTemp1
                ...
                <QuestionTemp1
                    ...
                    :subject="subject"
                    questionTitle="債券の売買"
                    :relatedProblems="['2025a6', '2025c17']"
                    :contents="[
                        // rev: 2026-06-28 確認済み
                        '正しい',
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :subject="subject"
                    questionTitle="国債"
                    :relatedProblems="['2025a18', '2025b18', '2025c18']"
                    :contents="[
                        // rev: 2026-06-28 確認済み
                        '正しい',
                        '正しい',
                        '正しい',
                        '個人向け国債には、「[[変動]]10年タイプ」と「[[固定]]５年タイプ」「[[固定]]３年タイプ」がある。', //p50
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="19"
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2025b9', '2025c20']"
                    :contents="[
                        // rev: 2026-06-29 確認済み
                        '正しい',
                        '正しい',
                        '正しい',
                        '一般に販売されている投資信託で、購入時に[[販売手数料がかかる]]ものであっても、確定拠出年金で購入する際には、[[原則販売手数料はかからない]]。', //p94
                    ]"
                />
                <QuestionTemp1
                    :questionNumber="21"
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2025a12', '2025b23', '2025c23']"
                    :contents="[
                        // rev: 2026-06-28 確認済み
                        '正しい',
                        '正しい',
                ...
                <QuestionTemp1
                    ...
                    :relatedProblems="['2025b24', '2025c24']"
                    :contents="[
                        // rev: 2026-06-29 確認済み
                        '正しい',
                        '正しい',
                        '金融資産が１金融機関に集中することは、一方では金融機関の破綻など万一の際のリスクも[[高く]]なる。そのような観点から、リスクヘッジするために取引する金融機関を[[複数]]にしておくことは基本的な選択といえる。', //p130
                        '正しい',
                    ]"
                />
                <QuestionTemp3
                ...
                <QuestionTemp2
                    ...
                    :items="[
                        ...
                        }, //40
                        {
                            ...
                            relatedProblems: ['2025a41', '2025b41', '2025c41'],
                        ...
                        }, //43
                        {
                            ...
                            relatedProblems: ['2025b45', '2025c44'],
                        ...
                        }, //47
                        {
                            ...
                            content: '日本で販売される外国投資信託は、日本証券業協会の自主ルールである「外国証券の取引に関する規則」における「外国投資信託受益証券の選別基準」に[[適合しているものに限るため]]、投資対象や運用制限において、[[ほぼ国内の投資信託と差異はない]]。', //p119
                        }, //47
                        {
                            // rev: 2026-06-29 確認済み
            ...
            <TestNavigationButtons previous-route="daigaku.sisan2025b" next-route="daigaku.sisan2024a" home-route="daigaku.index" />
        </section>
    </SeihoTestLayout>
</template>
